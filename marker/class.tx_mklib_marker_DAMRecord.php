 ...
 * @author Michael Wagner
 */
class tx_mklib_marker_DAMRecord extends tx_rnbase_util_BaseMarker {

	/**
	 * @return tx_mklib_marker_DAMRecord
	 */
	public static function getInstance(){
		return tx_rnbase::makeInstance('tx_mklib_marker_DAMRecord');
	}
	...
	public static function buildList($aRecords, $template, &$formatter, $confId, $marker){
		...
		$template = $listBuilder->render(
						...
						$template, 'tx_mklib_marker_DAMRecord',
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/marker/class.tx_mklib_marker_DAMRecord.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/marker/class.tx_mklib_marker_DAMRecord.php']);
}
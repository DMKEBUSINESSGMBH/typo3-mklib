...
class tx_mklib_tests_util_DateTest extends Sys25\RnBase\Testing\BaseTestCase
{
     ...
     */
    public function testGetTimestampByCalendarWeekDayAndYearReturnsCorrectTimestamps(): void
    {
     ...
     */
    public function testIsMysqlDate(): void
    {
     ...
     */
    public function testGetCalendarWeekDayAndYearByTimestampReturnsCorrectData(): void
    {
     ...
     */
    public function testGetTimesInTimeRangeReturnsCorrectDays(): void
    {
    ...
    public function testGetTimesInTimeRangeHandlesSummertimeCorrect(): void
    {

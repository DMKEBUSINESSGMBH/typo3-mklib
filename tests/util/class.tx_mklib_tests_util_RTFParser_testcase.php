...
class tx_mklib_tests_util_RTFParser_testcase extends tx_phpunit_testcase {
	...
	public function testParseReturnsCorrectPlainText(){
		...
		$this->assertEquals('Das ist unsere erste Kleinanzeige', $rtfParser->parse(), 'Der geparste text ist falsch. Vielleicht Magic Quotes ausgeschaltet oder Ähnliches?');
	}
	...
	public function testParseReturnsCorrectPlainTextInHtmlMode(){
		...
		$this->assertEquals('<div align="left"><span class="f0s21"><b>Das ist unsere </b><div align="left"><span class="f0s21">erste Kleinanzeige', $rtfParser->parse(), 'Der geparste text ist falsch. Vielleicht Magic Quotes ausgeschaltet oder Ähnliches?');
	}

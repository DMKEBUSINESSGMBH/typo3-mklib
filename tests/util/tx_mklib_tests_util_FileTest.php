...
{
    private function createTestfiles(string $testfolder): void
    {
    ...
    public function testCleanupFilesWithZipAndXml(): void
    {
        // @TODO: lifetime testen
        // testverzeichnis anlegen
        $testfolder = TYPO3\CMS\Core\Core\Environment::getVarPath().'/fixtures/toremove';
    ...
    public function testCleanupFilesRecursiveWithZipAndXml(): void
    {
        // @TODO: lifetime testen
        // testverzeichnis anlegen
        $testfolder = TYPO3\CMS\Core\Core\Environment::getVarPath().'/fixtures/toremove';
    ...
    public function testParseUrlFromParts(): void
    {
    ...
    #[PHPUnit\Framework\Attributes\DataProvider('getFiles')]
    public function testIsValidFile(string $filepath, bool $expectedReturnValue): void
    {

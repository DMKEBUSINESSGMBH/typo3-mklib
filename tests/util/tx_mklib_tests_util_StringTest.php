...
class tx_mklib_tests_util_StringTest extends Sys25\RnBase\Testing\BaseTestCase
{
     ...
     */
    public function testGetShortenedText(): void
    {
        $aRecord = [
     ...
     */
    public function testRemoveNoneLetters(): void
    {
     ...
     */
    public function testRemoveRepeatedlyOccurrings(): void
    {
        self::assertEquals(
    ...
    public function testObfusicateEmail(): void
    {
    ...
    public function testObfusicateContainedEmails(): void
    {
        $this->initSpamProtectionConfig();
    ...
    public function testObfusicateContainedEmailsIfNoContained(): void
    {
        $this->initSpamProtectionConfig();
    ...
    public function testConvertEmailToMailToLink(): void
    {
        $this->initSpamProtectionConfig();
    ...
    public function testConvertContainedEmailsToMailToLinks(): void
    {
        $this->initSpamProtectionConfig();
    ...
    public function testConvertContainedEmailsToMailToLinksIfNoContained(): void
    {
        $this->initSpamProtectionConfig();
     ...
     * wie über TS.
     */
    public static function initSpamProtectionConfig(): void
    {
     ...
     * @group unit
     */
    public function testRemoveLineBreaks(): void
    {
        $testString = "test1\ntest2\r\n";
     ...
     * @group unit
     */
    public function testRemoveMultipleWhitespaces(): void
    {

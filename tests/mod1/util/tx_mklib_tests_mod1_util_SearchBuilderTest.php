...
{
    #[PHPUnit\Framework\Attributes\DataProvider('providerMakeWildcardTerm')]
    public function testMakeWildcardTerm(string $term, string $field, bool $leadingWC, string $expected): void
    {
        $result = tx_mklib_mod1_util_SearchBuilder::makeWildcardTerm($term, $field, $leadingWC);
        self::assertEquals($expected, $result);
    }

    public static function providerMakeWildcardTerm(): array
    {
        return [
    ...
    public function testBuildFreeTextWithSearchWordAndNoCols(): void
    {
        $fields = [];
    ...
    public function testBuildFreeTextWithSearchWordAndCols(): void
    {
        $fields = [];
    ...
    public function testBuildFreeTextWithoutSearchWord(): void
    {
        $fields = [];

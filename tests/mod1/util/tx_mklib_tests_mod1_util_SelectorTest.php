...
class tx_mklib_tests_mod1_util_SelectorTest extends Sys25\RnBase\Testing\BaseTestCase
{
    ...
    public function testBuildFilerTableWithoutData(): void
    {
        $aData = [];
        self::assertEmpty($this->oSelector->buildFilterTable($aData), 'return nicht leer.');
    }

    public function testBuildFilerTableWithData(): void
    {
        $aData = [
            'search' => [
                'field' => 'testField 1',
    ...
    public function testShowFreeTextSearchFormWithEmptySearchString(): void
    {
        $out = [];
        $options = [
            'buttonName' => 'testName',
    ...
    public function testShowFreeTextSearchFormWithSearchString(): void
    {
        $out = [];
        $options = [
            'buttonName' => 'testName',
    ...
    public function testGetValueFromModuleDataWithExistingKey(): void
    {
        $GLOBALS['BE_USER']->uc['moduleData'][$this->oMod->getName()][$this->sModuleKey] = 'joh316';
        // key exists
    ...
    public function testGetValueFromModuleDataWithoutExistingKey(): void
    {
        $GLOBALS['BE_USER']->uc['moduleData'][$this->oMod->getName()][$this->sModuleKey] = 'joh316';
        self::assertEmpty($this->oSelector->getValueFromModuleData('someotherkey'), 'falscher Wert. 2');
    }

    public function testGetValueFromModuleDataWithNewValue(): void
    {
        $GLOBALS['BE_USER']->uc['moduleData'][$this->oMod->getName()][$this->sModuleKey] = 'joh316';
        $_POST = null;
    ...
    public function testSetValueToModuleDataWithEmptyData(): void
    {
        // vorhandene Daten
        $GLOBALS['BE_USER']->uc['moduleData'][$this->oMod->getName()][$this->sModuleKey] = 'joh316';
    ...
    public function testSetValueToModuleDataWithData(): void
    {
        // vorhandene Daten
        $GLOBALS['BE_USER']->uc['moduleData'][$this->oMod->getName()][$this->sModuleKey] = 'joh316';
    ...
    public function testShowHiddenSelectorWithDefaultId(): void
    {
        $data = [];
    ...
    public function testShowHiddenSelectorWithOneSelected(): void
    {
     ...
     * @group unit
     */
    public function testGetCrDateReturnArrayFormatsDatesCorrect(): void
    {
     ...
     * @group unit
     */
    public function testGetCrDateReturnArrayFormatsDatesCorrectIfValuesEmpty(): void
    {
        $selector = TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('tx_mklib_mod1_util_Selector');
     ...
     * @group unit
     */
    public function testGetDateFieldByKeyWhenNoPost(): void
    {
        $key = 'test';
     ...
     * @group unit
     */
    public function testGetDateFieldByKeyWhenPost(): void
    {
        $key = 'test';
     ...
     * @group unit
     */
    public function testShowDateRangeSelectorReturnsCorrectTimestampArray(): void
    {
        $formTool = $this->getMock(Sys25\RnBase\Backend\Form\ToolBox::class, ['createDateInput']);
        $formTool
            ->expects(self::any())
     ...
     * @group unit
     */
    public function testShowDateRangeSelectorReturnsCorrectTimestampArrayWhenPostValuesSet(): void
    {
        $formTool = $this->getMock(Sys25\RnBase\Backend\Form\ToolBox::class, ['createDateInput']);
        $formTool
            ->expects(self::any())
        ...
        $selector->expects(self::once())
            ...
            ->willReturn($expectedReturnArray);
     ...
     * @group unit
     */
    public function testShowDateRangeSelectorReturnsCorrectInputs(): void
    {
        $formTool = $this->getMock(Sys25\RnBase\Backend\Form\ToolBox::class, ['createDateInput']);
        $formTool
            ->expects(self::at(0))
     ...
     * @group unit
     */
    public function testShowDateRangeSelectorReturnsCorrectInputsWhenPostValuesSet(): void
    {
     ...
     * @group unit
     */
    public function testShowDateRangeSelectorSetModuleDataCorrect(): void
    {
        $formTool = $this->getMock(Sys25\RnBase\Backend\Form\ToolBox::class, ['createDateInput']);
        $formTool
            ->expects(self::any())

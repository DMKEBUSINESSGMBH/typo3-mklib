...
class tx_mklib_tests_mod1_decorator_BaseTest extends Sys25\RnBase\Testing\BaseTestCase
{
    ...
    public function testFormatWithUidColumn(): void
    {
    ...
    public function testFormatWithUidColumnAndNoEnableColumnsConfig(): void
    {
    ...
    public function testFormatWithLabelColumn(): void
    {
        $model = $this->getModel(
            [
                'uid' => 57,
    ...
    public function testFormatWithSysLanguageUidColumn(): void
    {
    ...
    public function testFormatWithActionsColumnBeingAdminDoesReturnDeleteLink(): void
    {
    ...
    public function testFormatWithActionsColumnBeingNoAdminDoesNotReturnDeleteLink(): void
    {
    ...
    public function testFormatWithActionsColumnAndNoEnableColumnConfigBeingAdmin(): void
    {
        $GLOBALS['BE_USER']->user['admin'] = 1;
        // base model liefert als table name immer 0
        // also setzen wir die columns für die tabelle 0
     ...
     */
    protected function getDecoratorMock(): object
    {

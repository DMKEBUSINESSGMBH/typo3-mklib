...
class tx_mklib_tests_mod1_searcher_abstractBaseTest extends Sys25\RnBase\Testing\BaseTestCase
{
    ...
    public function testGetResultListReturnsNoPagerAndEmptyMsgIfResultEmpty(): void
    {
    ...
    public function testGetResultReturnsCorrectResultsDependendOnHiddenSettings(): void
    {
    ...
    public function testGetResultListReturnsCorrectTableAndPagerIfSortLinkIsClickedAndSetsSortOptionTmoduleData(): void
    {
        $_GET['sortField'] = 'uid';
        $_GET['sortRev'] = 'asc';
    ...
    public function testGetResultListReturnsCorrectTableAndPagerIfSortingFromModuleDataAndSetsSortOptionToGetParams(): void
    {
     ...
     * @group unit
     */
    public function testSearchItemsWithoutOptions(): void
    {
     ...
     * @group unit
     */
    public function testSearchItemsWithLimit(): void
    {
        $res = $this->callInaccessibleMethod(
            $this->getSearchItemsSearcherMock(
                [],
     ...
     * @group unit
     */
    public function testSearchItemsWithLimitAndOffset(): void
    {
        $res = $this->callInaccessibleMethod(
            $this->getSearchItemsSearcherMock(
                [],
     ...
     * @group unit
     */
    public function testSearchItemsWithLimitAndOffsetAndFewResults(): void
    {
        $res = $this->callInaccessibleMethod(
            $this->getSearchItemsSearcherMock(
                [],
     ...
     * @group unit
     */
    public function testInitLoadsOwnLocalLangNotOverwritingExistingLabels(): void
    {
    ...
    {
        return $GLOBALS['LOCAL_LANG']['default'][$labelKey][0]['target'];
    }
}

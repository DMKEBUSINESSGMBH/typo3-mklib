...
class tx_mklib_tests_hooks_t3lib_tceforms_getSingleFieldClass_testcase extends Tx_Phpunit_TestCase
{
    ...
    public function testAddingRequiredEvalForSelects()
    {
        ...
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['inputNotRequiredField'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectNotRequired1Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectNotRequired2Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectNotRequired3Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectRequired6Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectNotRequired4Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectRequired1Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectRequired2Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectRequired3Field'],
            $row
        );
        $this->oTceForms->getSingleField(
            $this->testTable,
            $this->fieldMappings['selectRequired4Field'],
            $row
        );

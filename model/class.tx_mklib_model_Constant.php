...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mktegut/models/class.tx_mktegut_models_Constant.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mktegut/models/class.tx_mktegut_models_Constant.php']);
}

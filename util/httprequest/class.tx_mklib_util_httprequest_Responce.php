 ...
 */
class tx_mklib_util_httprequest_Responce {
	 ...
	 *
	 * In most cases, you would use tx_mklib_util_httprequest_Responce::fromString to parse an HTTP
	 * response string and create a new tx_mklib_util_httprequest_Responce object.
	 *
	...
	/**
	 * Create a new tx_mklib_util_httprequest_Responce object from a string
	 *
	 * @param string $response_str
	...
	public static function fromString($response_str) {
		...
		return new tx_mklib_util_httprequest_Responce($code, $headers, $body, $message, $version);
	}

}

if (defined('TYPO3_MODE') && $GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/mklib/util/class.tx_mklib_util_httprequest_Responce.php']) {
  include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/mklib/util/class.tx_mklib_util_httprequest_Responce.php']);
}

 ...
 */
class tx_mklib_util_list_Marker
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/util/list/class.tx_mklib_util_list_Marker.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/util/list/class.tx_mklib_util_list_Marker.php']);
}

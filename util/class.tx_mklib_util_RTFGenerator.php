...
class tx_mklib_util_RTFGenerator {
	...
	private function getDefaultFont($withTrailingSpace = true) {
		...
		if($withTrailingSpace) $font_buffer .= " ";
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/util/class.tx_mklib_util_RTFGenerator.php'])	{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/util/class.tx_mklib_util_RTFGenerator.php']);
}

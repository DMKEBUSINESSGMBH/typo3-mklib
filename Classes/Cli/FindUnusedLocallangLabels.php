...
/**
 * Tx_Mklib_Cli_FindUnusedLocallangLabels
 *
 * @package 		TYPO3
 * @subpackage	 	mklib
 ...
 */
class Tx_Mklib_Cli_FindUnusedLocallangLabels extends \TYPO3\CMS\Core\Controller\CommandLineController {
	...
	*/
	public function __construct() {
		...
		$this->cli_options[] = array('--searchFolder folders', 'comma separated list of absolute folder paths to search in', 'can be passed multiple times');
		// Setting help texts:

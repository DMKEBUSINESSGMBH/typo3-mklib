...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks']['tx_mklib_scheduler_cleanupTempFiles'] = [
    'extension' => 'mklib',
    'title' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_cleanupTempFiles_name',
    'description' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_cleanupTempFiles_taskinfo',
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks']['tx_mklib_scheduler_SchedulerTaskFreezeDetection'] = [
    'extension' => 'mklib',
    'title' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_SchedulerTaskFreezeDetection_name',
    'description' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_SchedulerTaskFreezeDetection_taskinfo',
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks']['tx_mklib_scheduler_DeleteFromDatabase'] = [
    'extension' => 'mklib',
    'title' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_DeleteFromDatabase_name',
    'description' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_DeleteFromDatabase_taskinfo',
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks']['tx_mklib_scheduler_SchedulerTaskFailDetection'] = [
    'extension' => 'mklib',
    'title' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_SchedulerTaskFailDetection_name',
    'description' => 'LLL:EXT:mklib/scheduler/locallang.xlf:scheduler_SchedulerTaskFailDetection_taskinfo',

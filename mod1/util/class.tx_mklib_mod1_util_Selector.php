...
class tx_mklib_mod1_util_Selector {
	...
	public function showFreeTextSearchForm (&$out, $key, array $options = array()) {
		...
		$out['button'] 	= $this->formTool->createSubmit(
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/mod1/util/class.tx_mklib_mod1_util_Selector.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mklib/mod1/util/class.tx_mklib_mod1_util_Selector.php']);
}
